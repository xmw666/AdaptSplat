...
def local_backup_src_code(
    ...
    exclude_dirs=('.claude','.vscode','.cursor',"wandb", ".git", "checkpoints", "experiments","data","data_re10k",'data_dl3dv','remote','sam','data_mipnerf360','data_tandt','data_replica'),
    verbose=True,
):
    """
...
def init_wandb_and_backup(config):
    ...
    local_backup_src_code(cur_dir, trgt_dir, extension_to_backup=extension_to_backup)
